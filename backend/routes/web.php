...
use App\Http\Controllers\Admin\ProdductReviewController; 
...
Route::get('/dashboard',[ProductCartController::class, 'SummaryOrder'])->name('admin.index');
...
Route::get('/status/complete/{id}',[ProductCartController::class, 'OrderDelete'])->name('order.delete');
